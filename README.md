...
- [x] При нажатии на кнопку<a id="header-nav-link" href="https://welltory.com/who-we-are" class="is__controls-menu menu__cta-button">Who we are</a> происходит переход на соответствующую страницу сайта
